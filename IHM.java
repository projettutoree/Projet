...
public class IHM {
	...
	public boolean demanderScenar() {
		boolean modeScenar;
		Console.println("Voulez-vous le mode scénario ? [V-F]");
					...
					for (int j = 0; j <= tailleMax - (Math.abs(tailleMax / 2 - i)); j++) {
						...
						if (objet != null) {
							if (objet.getJoueur() != null) {
								...
								case 1:
									Console.couleurFont(CouleurConsole.CYAN);
									break;
								case 2:
									Console.couleurFont(CouleurConsole.ROUGE);
									break;
								case 3:
									Console.couleurFont(CouleurConsole.BLEU);
									break;
								case 4:
									Console.couleurFont(CouleurConsole.VERT);
									break;
								case 5:
									Console.couleurFont(CouleurConsole.MAUVE);
									break;
								case 6:
